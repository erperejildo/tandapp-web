...
const features = [
  {
    to: '/es/caracteristicas/tandas-en-linea',
    icon: '&#8599;',
  ...
  {
    to: '/es/caracteristicas/ahorro-grupal',
    icon: '&#9826;',
  ...
  {
    to: '/es/caracteristicas/control-pagos',
    icon: '&#10003;',
  ...
  {
    to: '/es/caracteristicas/confianza',
    icon: '&#9829;',
  ...
  <div class="home">
    <section class="hero section section--warm">
      <div class="container hero__grid">
        ...
        <img
          src="/images/main.png"
          alt="Tres amigos sonriendo mientras organizan su tanda en Tandapp"
          class="hero__image"
          width="560"
          height="450"
          loading="eager"
